...
class MaskGAE_stage1(nn.Module):
    ...
    def forward(self,fc_graph,sc_graph,sigmoid=False):
        ...
        fc_pos_out = self.fc_edge_decoder(z_concat, fc_mased_edges, sigmoid=sigmoid)
        fc_neg_out = self.fc_edge_decoder(z_concat, fc_neg_edges, sigmoid=sigmoid)
        ...
        sc_pos_out = self.sc_edge_decoder(z_concat, sc_mased_edges, sigmoid=sigmoid)
        sc_neg_out = self.sc_edge_decoder(z_concat, sc_neg_edges, sigmoid=sigmoid)
